...
func initShirtRoom() {
	...
	stores = append(stores, &Store{
		...
		Type:        STORE_TYPE_SHIRTROOM,
		Title:       "씨엔엔",
		Description: "강남 씨엔엔 셔츠룸에서는 프리미엄 서비스와 고급스러운 분위기로 당신의 밤을 빛내줍니다. 맞춤형 케어와 독특한 경험으로 강남의 밤을 최고로 만들어 보세요.",
		Active: &Active{
			IsPermanentClosed: false,
			Reason:            "",
		},
...
func initFull() {
	stores = append(stores, &Store{
		...
		Title:       "세븐",
		Description: "강남 세븐 풀싸롱은 강남 지역에서 현대적인 인테리어와 최신 음향 시스템으로 유명한 곳입니다. 여기서는 친구들과 함께 즐거운 시간을 보내며 다양한 장르의 노래를 즐길 수 있어, 모든 연령대에 걸쳐 인기가 높습니다.",
		Active: &Active{
			IsPermanentClosed: false,
			Reason:            "",
		},
	...
	stores = append(stores, &Store{
		...
		Type:        STORE_TYPE_FULL,
		Title:       "심포니",
		Description: "강남 심포니 풀싸롱은 고급스러운 분위기와 프리미엄 서비스를 자랑하는 풀싸롱으로, 강남에서 특별한 밤을 보내고 싶은 이들에게 완벽한 장소입니다. 이곳에서는 최신 곡부터 클래식까지 폭넓은 음악 선택과 함께 품격 있는 노래 경험을 할 수 있습니다.",
		Active: &Active{
			IsPermanentClosed: false,
			Reason:            "",
		},
	...
	stores = append(stores, &Store{
		...
		Type:        STORE_TYPE_FULL,
		Title:       "애플",
		Description: "강남 애플 풀싸롱은 트렌디하고 밝은 분위기가 특징인 곳으로, 젊은 층에게 특히 인기가 많습니다. 최신 히트곡들로 항상 업데이트되는 음악 리스트와 함께 친구들과의 모임이나 파티에 이상적인 공간으로, 즐거운 시간을 보낼 수 있는 장소입니다.",
		Active: &Active{
			IsPermanentClosed: false,
			Reason:            "",
		},
